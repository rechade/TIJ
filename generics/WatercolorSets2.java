//: generics/WatercolorSets2.java
package net.gusto.tij.generics;
import net.gusto.tij.generics.watercolors.*;
import java.util.*;
import static net.mindview.util.Print.*;
import static net.mindview.util.Sets2.*;
import static net.gusto.tij.generics.watercolors.Watercolors.*;

public class WatercolorSets2 {
